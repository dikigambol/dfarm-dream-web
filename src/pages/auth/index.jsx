...
export default function Auth() {
	...
	return (
		<Fragment>
			{isAuth ? null :
				<section className="login bg-white" id="login">
								...
								{!forget ? (
									<form onSubmit={HandleLogin} method="POST">
										<div className="logo mb-3">
											...
											<h2 className="fw-semibold text-success fs-4">Login</h2>
										</div>
										<div className="mb-4">
										...
										<Link to="/dashboard" className="btn btn-success w-100 mb-3">Masuk</Link>
										<div className="mb-4 form-check">
											...
											<button type="button" className="float-end btn px-0 fw-normal forget-sandi" role="button" onClick={() => setForget(!forget)}>Lupa kata sandi?</button>
										</div>
									</form>
								) : (
									<form onSubmit={HandleForget} method="POST">
										<div className="logo mb-3">
											<img src="logo-light.svg" alt="Farm Dream" className="img-fluid img-logo" />
											<h2 className="fw-semibold text-success fs-4">Lupa Kata Sandi</h2>
										</div>
										<div className="mb-4">
										...
										<button type="button" className="btn btn-success w-100 mb-2" disabled={loading}>{loading ? "loading..." : "Atur ualng sandi"}</button>
										<div className="mb-4 form-check">
											<button type="button" className="float-end btn px-0 fw-normal" role="button" onClick={() => setForget(!forget)}>Halaman Login</button>
										</div>
									</form>
								)}
							</div>
